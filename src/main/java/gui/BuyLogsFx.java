...
public class BuyLogsFx {
    ...
    @FXML
    private TableColumn<BuyLog, Seller> buyLogsSeller;
    @FXML
    private TableView<BuyLog> buyLogs;
    @FXML
    private TableColumn<BuyLog, DeliveryStatus> buyLogsDeliveryStatus;
    @FXML
    private TableColumn<BuyLog, LocalDateTime> buyLogsDate;
